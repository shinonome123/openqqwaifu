...
class AsyncHttpTransport:
    ...
    async def request(
        ...
        *,
        ...
        started = time.perf_counter()
        try:
            # Test and server entrypoints often call async transports from short-lived
            # event loops. A per-request client avoids keeping sockets tied to an
            # event loop that may already be closed when the service shuts down.
