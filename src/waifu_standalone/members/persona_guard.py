...
class PersonaGuard:
    ...
    def sanitize_member_state(
        ...
        *,
        ...
        member = self._service.member_repository.get_member(
            group_id=group_id,
            user_id=user_id,
            character_id=character_id,
        )
        ...
        if cleaned_summary == str(member.get("profile_summary", "") or ""):
            return member
        return self._service.member_repository.save_member(
            {
                "group_id": group_id,
                "user_id": user_id,
                "character_id": character_id,
    ...
    def update_member_profile_summary(
        ...
        *,
        ...
        notes_count = self._service.knowledge_repository.count_knowledge_for_scope(
            "member",
            scope_id,
            character_id=current_character,
        )
